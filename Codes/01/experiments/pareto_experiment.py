"""Compatibility Pareto sweep utilities used by legacy visualization tests.

This module keeps older test and visualization workflows working while the main
project uses the newer grid-search + results aggregator pipeline.
"""
...
class ParetoExperiment:
    ...
    def compute_pareto_front(self, results: pd.DataFrame) -> pd.DataFrame:
        ...
        front = ParetoFrontComputer().compute(
            frame,
